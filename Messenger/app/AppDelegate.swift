...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var paymentsview : PaymentsViewController = PaymentsViewController()
	...
	func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        let customTabBarItem:UITabBarItem = UITabBarItem(title: "PAY", image: UIImage(named: "pay.png")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal), selectedImage: UIImage(named: "pay.png"))
        paymentsview.tabBarItem = customTabBarItem
        ...
        let navController5 = NavigationController(rootViewController: paymentsview)
